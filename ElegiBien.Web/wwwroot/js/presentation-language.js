...
(() => {
    ...
    const pairs = [
        ...
        ["OPTIANZA transforma medidas y datos simples en recomendaciones orientativas para ayudarte a comprar con más información.", "OPTIANZA turns measurements and simple data into practical estimates to help you make more informed purchases."],
        ["Herramientas principales de OPTIANZA", "Main OPTIANZA tools"],
        ["Ver detalles de todas las herramientas", "See details for all tools"],
        ["Características de OPTIANZA", "OPTIANZA features"],
        ...
        ["Alta", "High"],
        ["Muy alta", "Very high"],
        ["Permitir estadísticas anónimas para mejorar OPTIANZA.", "Allow anonymous statistics to improve OPTIANZA."],
        ["Permitir que los datos anónimos de esta consulta se incorporen en futuras estadísticas del Radar OPTIANZA.", "Allow anonymous data from this query to be included in future OPTIANZA Radar statistics."],
        ...
        ["Dañada", "Damaged"],
        ["Permitir incorporar esta consulta anónima al futuro Radar OPTIANZA.", "Allow this anonymous query to be included in the future OPTIANZA Radar."],
        ...
        ["Permitir analítica anónima para mejorar OPTIANZA.", "Allow anonymous analytics to improve OPTIANZA."],
        ["Permitir analítica anónima para mejorar OPTIANZA", "Allow anonymous analytics to improve OPTIANZA"],
        ...
        ["Resultado OPTIANZA", "OPTIANZA result"],
        ["Capacidad:", "Capacity:"],
        ...
        ["Secado", "Drying"],
        ["Resultado OPTIANZA: Pintura", "OPTIANZA result: Paint"],
        ...
        ["Resultado OPTIANZA: Cerámicos y pisos", "OPTIANZA result: Flooring and tiles"],
        ...
        ["Resultado OPTIANZA: Calefacción", "OPTIANZA result: Heating"],
        ["Ambiente:", "Room:"],
        ...
        ["Respondemos desde la dirección oficial de OPTIANZA.", "We reply from the official OPTIANZA address."],
        ...
        ["OPTIANZA utiliza los datos técnicos ingresados para realizar cálculos y comparar alternativas. Según la herramienta, pueden incluir dimensiones, características del ambiente, capacidades, precios, consumo, garantía u otros datos técnicos necesarios para producir el resultado.", "OPTIANZA uses the technical data you enter to perform calculations and compare alternatives. Depending on the tool, this may include dimensions, room characteristics, capacities, prices, consumption, warranty, or other technical data required to produce the result."],
        ...
        ["OPTIANZA puede utilizar Google Analytics para obtener métricas agregadas sobre el uso del sitio, como visitas, páginas consultadas y funcionamiento general de las herramientas.", "OPTIANZA may use Google Analytics to obtain aggregated site-usage metrics such as visits, viewed pages, and general tool performance."],
        ...
        ["Métricas internas y Radar OPTIANZA", "Internal metrics and OPTIANZA Radar"],
        ["La incorporación de eventos anónimos a métricas internas requiere consentimiento. La autorización para utilizar datos técnicos en futuras estadísticas agregadas de Radar OPTIANZA se solicita por separado.", "Adding anonymous events to internal metrics requires consent. Permission to use technical data in future aggregated OPTIANZA Radar statistics is requested separately."],
        ...
        ["Si considerás que OPTIANZA almacena información que te identifica o necesitás realizar una consulta sobre acceso, actualización, rectificación o supresión, utilizá el canal publicado en la página de", "If you believe OPTIANZA stores information that identifies you, or you need to ask about access, updating, correction, or deletion, use the channel published on the"],
        ...
        ["Los cálculos, comparaciones y puntajes proporcionados por OPTIANZA son orientativos y no reemplazan la evaluación de un técnico, instalador, fabricante o profesional matriculado cuando corresponda.", "Calculations, comparisons, and scores provided by OPTIANZA are estimates and do not replace an assessment by a technician, installer, manufacturer, or qualified professional when applicable."],
        ...
        ["Los precios, características y disponibilidad de productos ingresados por usuarios o provenientes de fuentes externas pueden cambiar y no son garantizados por OPTIANZA.", "Prices, product characteristics, and availability entered by users or obtained from external sources may change and are not guaranteed by OPTIANZA."],
        ["Puntaje OPTIANZA", "OPTIANZA Score"],
        ...
        ["Afiliados, anunciantes, comercios y patrocinadores no pueden modificar las reglas de cálculo ni el puntaje OPTIANZA.", "Affiliates, advertisers, retailers, and sponsors cannot modify the calculation rules or the OPTIANZA Score."],
        ["Publicidad y enlaces de afiliados", "Advertising and affiliate links"],
        ["OPTIANZA puede incorporar publicidad, enlaces de afiliados o referencias a comercios. Algunas interacciones comerciales pueden generar una compensación para el proyecto. Cuando corresponda, esa relación debe identificarse de forma clara y no altera el resultado técnico ni el orden determinado por el puntaje.", "OPTIANZA may include advertising, affiliate links, or retailer references. Some commercial interactions may generate compensation for the project. When applicable, that relationship must be clearly identified and does not alter the technical result or the ranking determined by the score."],
        ...
        ["Metodología OPTIANZA", "OPTIANZA Methodology"],
    ...
    const titlePairs = new Map([
        ["OPTIANZA - OPTIANZA", "OPTIANZA"],
        ["Qué aire acondicionado necesito - OPTIANZA", "What air conditioner do I need? - OPTIANZA"],
        ["Cuánta pintura necesito - OPTIANZA", "How much paint do I need? - OPTIANZA"],
        ["Cuántos cerámicos o pisos necesito - OPTIANZA", "How much flooring or tile do I need? - OPTIANZA"],
        ["Qué potencia de calefacción necesito - OPTIANZA", "How much heating power do I need? - OPTIANZA"],
        ["Comparar aires acondicionados - OPTIANZA", "Compare air conditioners - OPTIANZA"],
        ["Comparar pinturas - OPTIANZA", "Compare paints - OPTIANZA"],
        ["Comparar cerámicos y pisos - OPTIANZA", "Compare flooring and tiles - OPTIANZA"],
        ["Comparar equipos de calefacción - OPTIANZA", "Compare heating units - OPTIANZA"],
        ["Contacto - OPTIANZA", "Contact - OPTIANZA"],
        ["Política de privacidad - OPTIANZA", "Privacy Policy - OPTIANZA"],
        ["Términos de uso - OPTIANZA", "Terms of Use - OPTIANZA"],
        ["Metodología - OPTIANZA", "Methodology - OPTIANZA"],
        ["Resultado compartido - OPTIANZA", "Shared result - OPTIANZA"],
        ["Resultado compartido de pintura - OPTIANZA", "Shared paint result - OPTIANZA"],
        ["Resultado compartido de cerámicos y pisos - OPTIANZA", "Shared flooring and tiles result - OPTIANZA"],
        ["Resultado compartido de calefacción - OPTIANZA", "Shared heating result - OPTIANZA"],
        ["Ocurrió un problema - OPTIANZA", "Something went wrong - OPTIANZA"]
    ]);

    const descriptionPairs = new Map([
        ["OPTIANZA ayuda a calcular qué producto necesitás y comparar alternativas mediante criterios claros y explicables.", "OPTIANZA helps you estimate what you need and compare alternatives using clear, explainable criteria."],
    ...
    function dynamicEnglish(source) {
        ...
        match = /^OPTIANZA recomienda (.+) porque presenta la mejor adecuación general entre las alternativas analizadas\.$/.exec(value);
        if (match) return `OPTIANZA recommends ${match[1]} because it provides the best overall fit among the alternatives analyzed.`;

        match = /^OPTIANZA recomienda (.+) porque ofrece la mejor relación entre cobertura necesaria, costo total, lavabilidad y tiempo de secado\.$/.exec(value);
        if (match) return `OPTIANZA recommends ${match[1]} because it offers the best balance of required coverage, total cost, washability, and drying time.`;

        match = /^OPTIANZA recomienda (.+) porque ofrece la mejor relación entre cobertura comprada, costo total, excedente, resistencia y facilidad de reposición\.$/.exec(value);
        if (match) return `OPTIANZA recommends ${match[1]} because it offers the best balance of purchased coverage, total cost, excess material, durability, and replacement availability.`;
